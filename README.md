...
When creating a new module from this template, replace all `default-module` references with the new module name.
...
2) Update code & metadata
   ...
   - Any other references to `default-module` in code/config should be renamed accordingly.
